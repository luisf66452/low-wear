...
(() => {
  ...
  const PRODUCTS = [
    // Seleção Brasileira
    P('sel-principal-24', 'selecao', 'principal', 'Amarelinha da Copa', '2024', 99.90, ['S','M','L','XL'], 'Novo', 'disponivel', '#f6d21e', '#0b3d2e',
    ...
    P('sel-alt-24', 'selecao', 'alternativa', 'Azul da Copa', '2024', 94.90, ['S','M','L','XL'], 'Mais vendido', 'disponivel', '#0b3da0', '#f6d21e',
      { photos: ['img/spin/selecao-alt/01.png'],
        spin: Array.from({length: 21}, (_, i) => `img/spin/selecao-alt/${String(i + 1).padStart(2, '0')}.png`) }),
    P('sel-especial-24', 'selecao', 'especial', 'Amarelinha Classica', '2024', 89.90, ['S','M','L','XL'], 'Edição especial', 'disponivel', '#f6d21e', '#0b3d2e',
    ...
    // Flamengo
    P('fla-principal-24', 'flamengo', 'principal', 'Manto Rubro-Negro', '2024', 89.90, ['S','M','L','XL'], 'Novo', 'disponivel', '#a2110a', '#121212',
    ...
    P('fla-alt-24', 'flamengo', 'alternativa', 'Manto Rubro-Negro Branco', '2024', 84.90, ['S','M','L','XL'], 'Mais vendido', 'disponivel', '#f4f3ec', '#a2110a',
      { photos: ['img/spin/flamengo-alt/01.png'],
        spin: Array.from({length: 24}, (_, i) => `img/spin/flamengo-alt/${String(i + 1).padStart(2, '0')}.png`) }),
    P('fla-extra-24', 'flamengo', 'extra', 'Manto Rubro-Negro diferenciado', '2024', 79.90, ['S','M','L','XL'], null, 'disponivel', '#f4f3ec', '#a2110a',
      { photos: ['img/spin/flamengo-extra/01.png'],
        spin: Array.from({length: 24}, (_, i) => `img/spin/flamengo-extra/${String(i + 1).padStart(2, '0')}.png`) }),

    // Corinthians
    P('cor-principal-24', 'corinthians', 'principal', 'Fiel Alvinegra', '2024', 89.90, ['S','M','L','XL'], 'Novo', 'disponivel', '#f4f3ec', '#121212',
    ...
    P('cor-extra-24', 'corinthians', 'extra', 'Fiel Alvinegra diferenciada', '2024', 84.90, ['S','M','L','XL'], 'Edição especial', 'disponivel', '#f4f3ec', '#121212',
    ...
    // São Paulo
    P('sao-principal-24', 'sao-paulo', 'principal', 'Soberana Tricolor New Balance', '2024', 89.90, ['S','M','L','XL'], 'Novo', 'disponivel', '#f4f3ec', '#a2110a',
    ...
    P('sao-retro', 'sao-paulo', 'retro', 'Soberana Tricolor', '2019', 99.90, ['M','L','XL'], 'Retro', 'disponivel', '#f4f3ec', '#a2110a',
      { photos: ['img/spin/sao-paulo-retro/01.png'],
        spin: Array.from({length: 24}, (_, i) => `img/spin/sao-paulo-retro/${String(i + 1).padStart(2, '0')}.png`) }),

    // Palmeiras
    P('pal-principal-24', 'palmeiras', 'principal', 'Verdão Classico', '2024', 89.90, ['S','M','L','XL'], 'Mais vendido', 'disponivel', '#0b6e2c', '#f4f3ec',
    ...
    P('pal-retro', 'palmeiras', 'retro', 'Verdão Retro', '2019', 99.90, ['M','L','XL'], 'Retro', 'disponivel', '#0b6e2c', '#f4f3ec',
    ...
    // Cruzeiro
    P('cru-principal-24', 'cruzeiro', 'principal', 'Manto Celeste Azul', '2024', 89.90, ['S','M','L','XL'], 'Novo', 'disponivel', '#0b3da0', '#f4f3ec',
    ...
    P('cru-alt-24', 'cruzeiro', 'alternativa', 'Manto Celeste Branco', '2024', 84.90, ['S','M','L','XL'], 'Mais vendido', 'disponivel', '#f4f3ec', '#0b3da0',
